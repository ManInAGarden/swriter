...
namespace SWriter
{
    ...
    /// <summary>
    /// Helps searching and replacing Text in FlowDocuments
    /// </summary>
    public sealed class FindReplaceHelper
    {
        private FlowDocument inputDocument;
        private TextPointer currentPosition;

        /// <summary>
        /// Initializes a new instance of the <see cref="FindReplaceHelper"/> class given the specified <see cref="FlowDocument"/> instance.
        /// </summary>
        /// <param name="inputDocument">the input document</param>
        public FindReplaceHelper(FlowDocument inputDocument)
        {
            if (inputDocument == null)
            {
                throw new ArgumentNullException("Document may not be null");
            }
